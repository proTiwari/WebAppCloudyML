                              ...
                              children: [
                                                          ...
                                                          if (couponCodeController
                                                            ...
                                                            if (couponData != null) {
                                                              ...
                                                              print("return value: ${value['result']['couponStartDate']}");
                                                                  ...
                                                                  if(value['result']['couponType'] == 'global') {
                                                                  ...
                                                                  else if(value['result']['couponType'] == 'individual') {

                                                                    var endTime = value['result']['couponExpiryDate'];
                                                                    DateTime dateTime = DateFormat("EEE MMM dd yyyy HH:mm:ss 'GMT'Z").parse(endTime);
                                                                ...
                                                                } else if (errorOfCouponCode != null ) {
                                                                  print(couponAPI);
                                                                  var errorValue = json.decode(couponAPI['message']);
                                ...
                                Center(
                                  child: PaymentButton(
                                    ...
                                    buttonTextForCode: "$finalamountToDisplay",
                                    changeState: () {
                                      setState(() {
                                        // isLoading = !isLoading;
                                      });
