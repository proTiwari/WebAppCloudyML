...
class _HomeState extends State<Home> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      Provider.of<UserProvider>(context, listen: false).onStateChangedme(FirebaseAuth.instance.currentUser);
    });
  ...
  getHello() async {
    ...
    try {
      var response = await http.post(
        Uri.parse(
            'https://us-central1-cloudyml-app.cloudfunctions.net/helloWorld'),
        headers: headers,
      );
