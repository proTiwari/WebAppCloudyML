                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      padding:
                                          EdgeInsets.all(25 * verticalScale),
                                      decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(15),
                                        color: Colors.white,
                                      ),
                                      ...
                                      GoRouter.of(context).pushReplacementNamed(
                                          ...
                                          queryParams: {
                                            'cID': featuredCourse[index]
                                                .courseDocumentId,
                                            'courseName': featuredCourse[index]
                                                .courseName,
                                            'id':
                                                featuredCourse[index].courseId,
                  ...
                  child: Stack(
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsets.only(top: 15 * verticalScale),
                          child: Row(
                            children: [
                              Image.asset(
                                "assets/logo2.png",
